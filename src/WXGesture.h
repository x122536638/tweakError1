...
@property(nonatomic) float animationProgress; // @synthesize animationProgress;
- (void)beginTransitionAnimation:(int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)setGestureIsEnable:(BOOL)arg1;
@property(nonatomic) float startingTranslationValue; // @synthesize startingTranslationValue;
